...
export class FormulaireComponent implements OnInit{
  ...
  onSubmit(){
    ...
    // // after form filling we will have to send form data to backend using this method
    // this.httpService.addNewRecord(this.formulaireForm.value,2).subscribe(response => {
